      ...
      <div className="max-w-screen-xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
          ...
          <div className="flex flex-col gap-3 md:items-end">
            ...
            <a href="https://t.me/5am_store_official" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border border-zinc-700 text-white text-xs font-mono uppercase px-4 py-2 hover:border-white transition-all">
